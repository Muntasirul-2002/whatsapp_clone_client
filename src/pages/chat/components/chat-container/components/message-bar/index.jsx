...
import { UPLOAD_FILE } from "../../../../../../lib/api-client";
    ...
    <div className="h-[10vh] bg-[#1c1d25] flex justify-center items-center px-8 mb-6 gap-5">
      <div className="flex-1 flex bg-[#2a2b33] rounded-md items-center gap-5 pr-5">
        ...
        <button className="text-neutral-500 focus:border-none focus:outline-none focus:text-white duration-300 transition-all cursor-pointer">
          <GrAttachment onClick={handleFileClick} className="text-2xl" />
        </button>
      ...
      <button
        className="bg-[#8417ff] rounded-md flex items-center justify-center p-5 focus:border-none hover:bg-[#741bda] focus:bg-[#741bda] focus:outline-none focus:text-white transition-all duration-300 cursor-pointer"
