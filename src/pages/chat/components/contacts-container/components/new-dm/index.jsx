...
import { SEARCH_CONTACT } from "../../../../../../lib/api-client";
                    ...
                    <div className="w-12 h-12 relative">
                      <Avatar className=" h-12 w-12 rounded-full overflow-hidden">
                        {contact.image ? (
                          ...
                          <div
                            className={`uppercase w-12 h-12 text-lg border-none flex items-center justify-center ${getColor(
                              contact.color
                            )}`}
                          >
            ...
            <div className="flex-1 md:flex mt-5 md:mt-0 flex-col justify-center items-center duration-1000 transition-all">
              ...
              <div className="text-opacity-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transition-all duration-300 text-center">
                <h3 className="poppins-medium">
                  ...
                  <span className="text-purple-500 font-bold">Contact </span>
